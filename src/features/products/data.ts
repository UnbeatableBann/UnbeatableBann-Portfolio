export interface Product {
  ...
  overview: {
    ...
    bullets: string[];
    capabilities: {
      iconName: "brain" | "cpu" | "database" | "network" | "shield" | "fileText" | "sparkles" | "list";
      name: string;
      desc: string;
    }[];
  };
...
export const PRODUCTS_DATA: Product[] = [
  {
    ...
    description: "An autonomous AI teaching assistant that listens, understands, and generates educational aids in real-time during lectures. It captures audio input, extracts semantic structures, and dynamically serves visual maps, quizzes, and summaries to students.",
    excerpt: "Transforming classrooms through autonomous educational AI helpers that generate classroom materials in real time.",
    ...
    overview: {
      ...
      capabilities: [
        { iconName: "network", name: "Mind Maps", desc: "Visual concept maps from lecture context." },
    ...
    problem: "Teachers spend an average of 10-15 hours a week manually drafting quizzes, summaries, and lesson materials, taking away crucial time from student mentorship. Existing static tools do not adapt to live class discussions.",
    solution: "Curio listens to live lectures, maps spoken words to a dense educational database using hybrid semantic search, and dynamically builds high-fidelity educational outputs, reducing prep time by 80%.",
    architecture: {
  ...
  H --> I[React Frontend Dashboard]`
    ...
    roadmap: [
      { phase: "Phase 1", title: "Real-time Auditory Pipeline", desc: "WebSocket audio translation layers.", done: true },
      { phase: "Phase 2", title: "Multi-Agent Refinement", desc: "Splitting slide creation and quiz creation agents.", done: true },
      { phase: "Phase 3", title: "LMS Integrations", desc: "Syncing materials to Google Classroom and Canvas.", done: false }
    ],
  ...
  },
  {
    ...
    description: "An AI-powered interviewer that conducts structured, adaptive, and unbiased interviews at scale. It responds to candidate answers dynamically, asks intelligent follow-ups, profiles coding competencies, and grades responses based on rubric constraints.",
    excerpt: "Conducting scalable, adaptive, and bias-free interviews with deep technical evaluations and visual logs.",
    ...
    overview: {
      ...
      capabilities: [
        { iconName: "brain", name: "Dynamic Follow-ups", desc: "Asks candidates to explain complex code lines." },
        { iconName: "cpu", name: "Sandbox Compiler", desc: "Validates code compilations dynamically." },
        { iconName: "shield", name: "Proctoring Integrity", desc: "Verifies visual attention and tab focus." },
        { iconName: "fileText", name: "Grading Rubric", desc: "Detailed breakdown of scoring points." }
      ]
    },
    problem: "Technical recruiting teams waste hundreds of hours screening candidates who copy-paste solutions. Conversely, standard linear coding puzzles fail to capture true system engineering and problem-solving skills.",
    workspaceMode: "branch",
    solution: "An adaptive interview agent that doesn't just look for correct syntax, but actively probes code efficiency, testing for edge cases and forcing candidate interaction to verify reasoning depth.",
    architecture: {
  ...
  D --> G[Rubric Scoring Matrix]`
    ...
    roadmap: [
      { phase: "Phase 1", title: "Interactive Code Editor", desc: "Monaco Editor integration with sandbox loops.", done: true },
      { phase: "Phase 2", title: "Speech Conversational Loop", desc: "Real-time speech-to-speech audio integrations.", done: true },
      { phase: "Phase 3", title: "Team Rubric Designer", desc: "Allowing HR teams to customize their grading criteria.", done: false }
    ],
    related: ["curio"],
    metrics: [
  ...
  },
  {
    ...
    description: "A domain-specific RAG system for healthcare professionals to query medical databases and get accurate, annotated, and fully cited answers from complex clinical documentation.",
    excerpt: "A highly cited, secure clinical search engine mapping medical documentation to structured answers.",
    ...
    overview: {
      ...
      capabilities: [
        { iconName: "database", name: "Hybrid Chunking", desc: "Splitting docs by semantic medical headers." },
        { iconName: "shield", name: "PII Scrubbing", desc: "Scrubbing patient identity profiles dynamically." },
        { iconName: "network", name: "Ontology Mapping", desc: "Synonym resolution using UMLS vocabularies." },
        { iconName: "fileText", name: "Medical Citations", desc: "Clickable PDF reference attachments." }
      ]
    },
    problem: "Medical practitioners waste crucial time hunting through disjointed EHRs, clinical guidelines, and research files. Generic models hallucinate drug interactions, presenting extreme clinical risks.",
    solution: "A medical search system utilizing hybrid sparse-dense embedding models. It aligns query vectors with clinical knowledge nodes in Qdrant, providing answers that are 100% cited back to reference documents.",
    architecture: {
  ...
  F --> G[Practitioner Response]`
    ...
    roadmap: [
      { phase: "Phase 1", title: "Ontology Parser", desc: "Integrating UMLS term-matching loops.", done: true },
      { phase: "Phase 2", title: "Qdrant Database", desc: "Setting up dense/sparse hybrid ingestion.", done: true },
      { phase: "Phase 3", title: "Multi-PDF Uploads", desc: "Allowing users to upload entire medical folders.", done: false }
    ],
    related: ["curio"],
    metrics: [
  ...
  },
  {
    ...
    description: "A low-latency infrastructure connecting quantitative Python trading pipelines to MetaTrader 5 terminals, featuring memory-mapped IPC, automatic order routing, and failover management.",
    excerpt: "Low-latency market bridge connecting Python research pipelines to MetaTrader 5 execution terminals.",
    ...
    overview: {
      ...
      capabilities: [
        ...
        { iconName: "database", name: "Tick Logging", desc: "Logging price changes inside Redis arrays." },
        { iconName: "shield", name: "Risk Guardrails", desc: "Immediate order cancelation on connection loss." },
        { iconName: "network", name: "Multi-Terminal", desc: "Handling orders across multiple terminals." }
      ]
    },
    problem: "Standard quantitative trading setups suffer from high latency and disconnected interfaces. Standard socket protocols add milliseconds of execution slippage, leading to poor fills.",
    solution: "A C++ execution wrapper linked to Python via shared memory channels, delivering orders to MT5 within 800 microseconds and monitoring real-time price changes.",
    architecture: {
  ...
  E --> F[Market Executions]`
    ...
    roadmap: [
      { phase: "Phase 1", title: "C++ Wrapper DLL", desc: "Shared memory channel structures.", done: true },
      { phase: "Phase 2", title: "Redis Tick Store", desc: "Real-time pricing data capture.", done: true },
  ...
  },
  {
    ...
    description: "An algorithmic trading module that scans multiple asset markets for statistical price discrepancies, optimizes weights using mean-variance analysis, and places trade signals.",
    excerpt: "Algorithmic statistical arbitrage scanner and automated mean-variance portfolio model.",
    ...
    overview: {
      ...
      capabilities: [
        { iconName: "brain", name: "Cointegration", desc: "Finding historical price-spread relationships." },
        { iconName: "cpu", name: "Optimizer Engine", desc: "Sizing trades using Scipy solvers." },
        { iconName: "shield", name: "Drawdown Guard", desc: "Auto-reducing capital size on high volatility." },
        { iconName: "database", name: "Metrics Logger", desc: "Saving daily performance vectors." }
      ]
    },
    problem: "Scoping statistical opportunities across thousands of asset pairs manually is impossible. Standard static portfolios suffer from large drawdowns during volatile structural market shifts.",
    solution: "A automated numerical optimizer that calculates correlation vectors, sizes positions dynamically based on volatility, and executes trades via the MT5 bridge.",
    architecture: {
  ...
  E --> F[MT5 Infrastructure Bridge]`
    ...
    roadmap: [
      { phase: "Phase 1", title: "Pair Scanner", desc: "Numerical cointegration tests.", done: true },
      { phase: "Phase 2", title: "Sharpe Optimizer", desc: "Scipy mean-variance execution.", done: true },
      { phase: "Phase 3", title: "Multi-Asset Engine", desc: "Extending models to futures and crypto.", done: false }
    ],
