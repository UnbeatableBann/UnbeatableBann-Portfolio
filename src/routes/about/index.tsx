  ...
  return (
    <main className="min-h-screen bg-[#FAFAF8] text-[#111111] overflow-x-hidden">
      ...
      <section
        ref={contactRef}
        id="contact"
        className="py-24 border-t border-border bg-[#FAFAF8] scroll-mt-[0px]"
      >
              ...
              <div className="bg-white rounded-[16px] border border-[#e8e8e8] p-6 flex flex-col items-center text-center gap-5 min-h-[260px] justify-between">
                ...
                <div className="space-y-2 flex-grow flex flex-col justify-center">
                  ...
                  <a
                    ...
                    onCopy={() => trackEvent("email_copy", { location: "Contact" })}
                  ...
                  <a
                    ...
                    onClick={() =>
                      trackEvent("social_click", {
                        platform: "LinkedIn",
                        location: "Contact",
                        destination_url: "https://linkedin.com/in/shadab-jamadar",
                      })
                    }
                    ...
                    <a
                      ...
                      onClick={() =>
                        trackEvent("social_click", {
                          platform: "GitHub",
                          location: "Contact",
                          destination_url: "https://github.com/UnbeatableBann",
                        })
                      }
                    ...
                    <a
                      ...
                      onClick={() =>
                        trackEvent("social_click", {
                          platform: "Medium",
                          location: "Contact",
                          destination_url: "https://medium.com/@shadabjamadar",
                        })
                      }
                      className="text-xs text-muted hover:text-accent font-semibold transition-colors flex items-center gap-1"
                    >
